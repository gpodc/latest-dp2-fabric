...
const channelName = 'c3';
const chaincodeName = 'sensorDataContract3';
const mspOrg3 = 'Org3MSP';
const walletPath = path.join(__dirname, 'wallet');
const org3UserId = 'node-app-user3';
...
app.listen(port, () => {
	console.log(`Middleware service listening at http://node-app-service3:${port}`);
	console.log(`Data query can now be accessed at http://node-app-service3:${port}/data`);
