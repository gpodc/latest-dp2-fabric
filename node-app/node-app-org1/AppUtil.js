...
exports.buildWallet = async (Wallets, walletPath, userName) => {
	...
	try {
		...
		const certPath = path.resolve(__dirname, './organizations/peerOrganizations/org1.iot-fabric.com/users/User1@org1.iot-fabric.com/msp/signcerts/User1@org1.iot-fabric.com-cert.pem');
		const keyPath = path.resolve(__dirname, './organizations/peerOrganizations/org1.iot-fabric.com/users/User1@org1.iot-fabric.com/msp/keystore/priv_sk');
